...
class WordApiDatasource {
  ...
  static const String papagoBaseUrl = 'https://openapi.naver.com/v1/papago/n2mt';
  ...
  Future<String> getWordMean(String example) async {
    ...
    String result = '';
   try{
      final response = await networkManager.request(RequestMethod.post, papagoBaseUrl,headers: headers,queryparameters: queryparameters);
      print(response.data);
